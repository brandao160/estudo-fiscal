...
- Modelos grátis costumam ter um contexto bem menor que Gemini/Claude tinham — por isso `EDITAL_AI_MAX_CHARS` em `index.html` foi reduzido (60.000 caracteres) pra não estourar o contexto com editais grandes cheios de regras de inscrição irrelevantes ao conteúdo programático.
